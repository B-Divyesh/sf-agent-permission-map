...
- Resolve Claude Code and Codex permission files across global, repo, and worktree layers.
- Mark exact duplicate matchers as effective or shadowed.
- Print terminal, JSON, and Markdown reports.
- Ship a one-command sandboxed demo.
